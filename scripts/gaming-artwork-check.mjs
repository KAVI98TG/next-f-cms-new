...
check('Artwork editor keeps supplier-sync implementation guidance out of operator UI',!page.includes('Supplier identity can refresh during sync while NEXT F public overrides remain protected.'));
