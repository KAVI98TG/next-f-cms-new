...
check('release manifest matches package version',state.version===pkg.version&&state.version==='1.0.62');
...
check('release declares exact canonical parent and valid lifecycle state',state.baseline==='1.0.61'&&(candidateState||canonicalState));
