...
const checks=[
  ...
  ["shared badges use the global 12px status-label standard", components.includes(".badge { display: inline-flex; align-items: center; justify-content: center; min-height: 24px; padding: 0 9px; border-radius: 6px; font-size: 12px;") && components.includes("text-transform: none; white-space: nowrap;")],
  ["operation headings cannot restyle action badges", components.includes(".operation-section__head > div:first-child > span:first-child") && !components.includes(".operation-section__head span {")],
  ["gaming family badges inherit shared sizing", !components.includes(".gaming-family-kinds .badge")],
