...
export function CatalogVNextPage() {
  ...
  const productCols: DataTableColumn<NextFGamingProduct>[] = [
    ...
    { key: "offers", header: "Offers", width: "110px", render: (product) => { const stats = productStats.get(product.id); return <div className="entity-cell"><strong>{stats?.offerCount ?? 0}</strong><small>{stats?.enabledOfferCount ?? 0} public</small></div>; } },
