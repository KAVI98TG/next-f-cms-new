        ...
        <div className="gaming-product-editor__main">
          <section className="gaming-editor-section">
            ...
            <div className="form-grid form-grid--two gaming-product-editor__fields">
              <FormField label="Public name" action={<button className="inline-field-action" type="button" onClick={() => setSelectedProduct({ ...selectedProduct, displayName: undefined, name: selectedProduct.sourceName ?? selectedProduct.name })}>Use supplier name</button>}>
