...
export const BACKEND_API_OPERATIONS: ApiOperationDefinition[] = [
  ...
  { name: "customer.change.submit", kind: "command", allowedPrincipals: ["customer"], workspaceScoped: true, idempotency: "required", description: "Submit a customer proposal after V0.16 authorization evaluation." },
  ...
  { name: "public.conversion.track", kind: "command", allowedPrincipals: ["public"], workspaceScoped: false, idempotency: "required", description: "PII-free allowlisted first-party conversion event collection. Event payloads are constrained by the V0.19 public-site event registry." },
