...
export function IdentityPage() {
  ...
  return <div className="page">
    ...
    <div className="compact-metrics">
      ...
      <MetricCard label="Staff links" value={String(staffLinks.filter((link) => link.status === "active").length)} detail="Identity → staff principal" icon={Link2}/>
    ...
    <Card className="architecture-callout"><strong>Identity ≠ authorization</strong><p>Creating or verifying a NEXT F Account establishes identity only. It does not grant internal CMS access, Customer Workspace membership, site access, or website-management permissions. Staff authorization remains on Platform Users/Roles; customer authorization is established by explicit workspace membership and later entitlement/contract resolution.</p></Card>
